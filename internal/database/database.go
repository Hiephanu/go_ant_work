...
type Service interface {
	...
	FindAccountByUsername(username string) (*Account, error)
	FindAllAccounts(page int64, perPage int64) ([]Account, error)
	UpdateAccount(account *Account) error
	DeleteAccount(accountId string) error

	CreateUser(user *User) (string, error)
	FindUserById(userId string) (*User, error)
	FindAllUsers(page int64, perPage int64) ([]User, error)
	UpdateUser(user *User) (*User, error)
	DeleteUser(userId string) (string, error)
	FindUserByAccountId(accountId string) (*User, error)
}
